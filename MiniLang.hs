...
-- NB. This file is autogenerated, but I include it in this repository, because the file is needed to run `stack build`.
-- This way, someone who doesn't have GF installed can run this step before installing GF.
-- Not a recommended practice otherwise to put autogenerated files under version control.
